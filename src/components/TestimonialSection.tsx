  ...
  return (
    <section className="py-20 relative overflow-hidden" id="reviews">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="block md:hidden overflow-x-auto scrollbar-hide pb-2 pt-2">
          <div className="flex gap-6 min-w-max px-2">
            {reviews.map((r, i) => (
              <div key={i} className="min-w-[300px] flex-shrink-0 group relative">
                {/* Card */}
                <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-amber-400/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-amber-500/20 h-full">
                  {/* Quote Icon */}
                  ...
                  {/* Divider */}
                  <div className="h-px w-full bg-gradient-to-r from-transparent via-amber-400/30 to-transparent mb-4"></div>

                  {/* Reviewer Info */}
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      <div className="absolute inset-0 bg-amber-400/20 rounded-full blur-md"></div>
                      <div className="relative w-12 h-12 bg-gradient-to-br from-amber-400 to-amber-500 rounded-full flex items-center justify-center shadow-lg">
                    ...
                    <div className="text-left">
                      <h4 className="font-bold text-amber-400 text-base group-hover:text-amber-300 transition-colors">
                        {r.name}
                      </h4>
                      <p className="text-green-200/70 text-xs">{r.role}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="hidden md:grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          {reviews.map((r, i) => (
            <div key={i} className="group relative">
              <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:border-amber-400/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-amber-500/20 h-full">
                <div className="absolute top-6 right-6 opacity-20 group-hover:opacity-30 transition-opacity">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-green-200/70 text-sm">{r.role}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="text-center mt-12">
          <p className="text-green-200 mb-4">
            มีลูกค้ามากกว่า 1,000+ คนที่ไว้วางใจ
          </p>
