        ...
        <div key={i} className="group relative">
          <div className="relative bg-white/10 rounded-2xl p-6 border border-white/20 hover:border-amber-400/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl text-center hover:shadow-amber-500/20 h-full">
            <div className="relative mb-6">
              ...
              <div className="relative inline-flex items-center justify-center w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-amber-400 to-amber-500 rounded-full shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300 mx-auto">
                <div className="text-green-900">{b.icon}</div>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-green-200/70 text-xs md:text-sm italic mb-3">
                {b.subtitle}
              </p>
              <div className="h-px w-12 md:w-16 bg-gradient-to-r from-transparent via-amber-400/50 to-transparent mx-auto mb-4"></div>
